...
RUN mkdir binaryen
RUN wget -qO- https://github.com/WebAssembly/binaryen/releases/download/version_116/binaryen-version_116-x86_64-linux.tar.gz | tar xvz -C ./binaryen binaryen-version_116 --strip=1
